...
@section('page-title', 'Edit Environment')

@section('panel-heading', 'Edit Environment' )
...
<div class="col-xs-12 col-sm-8 col-sm-offset-1 col-md-6 col-md-offset-1 col-lg-4 col-lg-offset-1">
	...
	{!! Form::model( $environment, ['method' => 'PATCH', 'route' => ['environments.update', $environment->id]]) !!}

		{{-- Include shared form partial --}}
		@include('environments/_form', ['submitButtonText' => 'Update'])
	...
	{!! Form::close() !!}
		...
		{{-- Delete the record --}}
	{!! Form::open(['method' => 'DELETE', 'route' => ['environments.destroy', $environment->id]]) !!}

		<div class="form-group">
		    <button class="btn btn-danger" type="button" data-toggle="modal" 
			    data-target="#confirmDelete" data-title="Are you sure?" 
			    data-message="Delete {{ $environment->name }} Environment?">
