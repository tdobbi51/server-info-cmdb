...
@section('page-title', 'Create Dev Team')

@section('panel-heading', 'Add New Dev Team')
...
<div class="col-xs-12 col-sm-8 col-sm-offset-1 col-md-6 col-md-offset-1 col-lg-4 col-lg-offset-1">
	...
	{!! Form::open(array('route' => 'devteams.store')) !!}


		{{-- Include shared form partial --}}
		@include('devteams/_form', ['submitButtonText' => 'Submit'])
